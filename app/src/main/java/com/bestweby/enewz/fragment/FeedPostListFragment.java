...
import com.bestweby.enewz.adapter.recycler.FeedPostListAdapter;
import com.bestweby.enewz.app.BaseActivity;
import com.bestweby.enewz.cache.constant.AppConstants;
import com.bestweby.enewz.databinding.FeedPostListFragmentLayoutBinding;
...
public class FeedPostListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        context = getActivity();
        binding = DataBindingUtil.inflate(inflater, R.layout.feed_post_list_fragment_layout, container, false);
    ...
    private void initListener() {
        feedPostListAdapter.setItemClickListener(new ItemViewClickListener() {
            @Override
        ...
        feedPostListAdapter.setMenuItemClickListener(new MenuItemClickListener() {
            @Override
    ...
    private void initRecyclerLayout() {
        feedPostListAdapter = new FeedPostListAdapter(context, postList);
        ...
        binding.primaryRecycler.setAdapter(feedPostListAdapter);
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            if (response.body().size() > 0) {
                                ...
                                feedPostListAdapter.notifyDataSetChanged();
