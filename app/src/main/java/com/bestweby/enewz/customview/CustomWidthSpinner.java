 ...
 */
public class CustomWidthSpinner extends AppCompatSpinner {

    public CustomWidthSpinner(Context context) {
        super(context);
    }

    public CustomWidthSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomWidthSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
