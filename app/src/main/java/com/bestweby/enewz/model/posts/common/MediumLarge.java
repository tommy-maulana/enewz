...
public class MediumLarge implements Parcelable
{
    ...
    public final static Parcelable.Creator<MediumLarge> CREATOR = new Creator<MediumLarge>() {
     ...
     * @param mimeType
     */
    public MediumLarge(String file, Integer width, Integer height, String mimeType, String sourceUrl) {
        super();
        this.file = file;
        this.width = width;
        this.height = height;
