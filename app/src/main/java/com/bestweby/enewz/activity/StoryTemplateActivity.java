...
import com.bestweby.enewz.adapter.recycler.StoryPostListAdapter;
...
import com.bestweby.enewz.databinding.ActivityStoryTemplateLayoutBinding;
...
public class StoryTemplateActivity extends BaseActivity {

    private ActivityStoryTemplateLayoutBinding binding;
    private NavHeaderLayoutBinding navHeaderbinding;

    private TemplateSliderAdapter sliderAdapter;
    private HomeCategoryAdapter categoryAdapter;
    private StoryPostListAdapter postListAdapter;
    ...
    protected void onResume() {
        ...
        binding.mainNavView.getMenu().getItem(3).setChecked(true);
    }
    ...
    public void onBackPressed() {
        if (this.binding.homeDrawerlayout.isDrawerOpen(GravityCompat.START)) {
            ...
            AppHelper.showShortToast(StoryTemplateActivity.this, "Please click BACK again to exit");
    ...
    private void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_story_template_layout);
    ...
    private void initListener() {
        ...
        binding.homeToolbar.toolbarMenuNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(StoryTemplateActivity.this, NotificationActivity.class));
            }
        });
        ...
        binding.homeToolbar.toolbarMenuSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(StoryTemplateActivity.this, SearchPostActivity.class));
            }
        });
        ...
        categoryAdapter.setItemClickListener(new ItemViewClickListener() {
            ...
            public void onItemViewClickGetPosition(int position, View view) {
                ...
                bundle.putSerializable(AppConstants.BUNDLE_LAYOUT_TYPE, AppConstants.ListLayoutType.GRID);
                startActivity(new Intent(StoryTemplateActivity.this, CategoryPostsActivity.class).putExtras(bundle));
            }
        });
            ...
            public void onItemViewClickGetPosition(int position, View view) {
                switch (view.getId()) {
                    case R.id.parent_view:
                        ...
                        startActivity(new Intent(StoryTemplateActivity.this, PostDetailActivity.class).putExtras(bundle));
                        break;
                }
            }
        });
    ...
    private void initRecyclerView() {
        categoryAdapter = new HomeCategoryAdapter(StoryTemplateActivity.this, categoryList);
        binding.contentView.categoryRecycler.setLayoutManager(new LinearLayoutManager(StoryTemplateActivity.this, LinearLayoutManager.HORIZONTAL, false));
        ...
        postListAdapter = new StoryPostListAdapter(StoryTemplateActivity.this, postList);
        binding.contentView.primaryRecycler.setLayoutManager(new StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL));
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    ...
                    (StoryTemplateActivity.this).runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
    ...
    private void loadAllPosts(int pageNumber) {
        if (NetworkChangeReceiver.isNetworkConnected()) {
            if (pageNumber == AppConstants.PAGE_NUMBER) {
                ...
                binding.contentView.storyShimmerView.shimmerView.setVisibility(View.VISIBLE);
            }
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            if (response.body().size() > 0) {
                                ...
                                binding.contentView.storyShimmerView.shimmerView.setVisibility(View.GONE);
                            } else {
                                if (postList.size() == 0) {
                                    binding.contentView.emptyListLayout.removeAllViews();
                                    binding.contentView.emptyListLayout.addView(setEmptyLayout(StoryTemplateActivity.this, getString(R.string.no_data)));
