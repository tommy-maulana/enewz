    ...
    private void initListener() {
        ...
        binding.homeToolbar.toolbarMenuNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(NewsTemplateActivity.this, NotificationActivity.class));
            }
        });
    ...
    private void initSliderViewPager() {
        ...
        sliderAdapter.setSliderItemClickListerner(new ItemClickListener() {
            ...
            public void onItemClickGetPosition(int position) {
                ...
                startActivity(new Intent(NewsTemplateActivity.this, PostDetailActivity.class).putExtras(bundle));
            }
        });
    }

    private void initTablayout() {
        newsTemplatePagerAdapter = new NewsTemplatePagerAdapter(getSupportFragmentManager(), (ArrayList<CategoryModel>) categoryList);
        binding.categoryPostsViewpager.setAdapter(newsTemplatePagerAdapter);
...
/*        NUM_PAGES = featuredList.size();
        new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    ...
                    (NewsTemplateActivity.this).runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
    ...
    private void loadCategories() {
        if (NetworkChangeReceiver.isNetworkConnected()) {
            ...
            binding.homeLinearShimmerView.shimmerView.setVisibility(View.VISIBLE);
                ...
                public void onResponse(@NonNull Call<List<CategoryModel>> call, @NonNull Response<List<CategoryModel>> response) {
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            ...
                            binding.homeLinearShimmerView.shimmerView.setVisibility(View.GONE);
                        }
                    } else {
                        AppHelper.showShortToast(context, getString(R.string.failed_msg));
                    }
