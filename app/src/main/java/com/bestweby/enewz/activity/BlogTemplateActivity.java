...
import com.bestweby.enewz.adapter.viewpager.BlogTemplatePagerAdapter;
...
import com.bestweby.enewz.databinding.ActivityBlogTemplateLayoutBinding;
...
public class BlogTemplateActivity extends BaseActivity {
    ...
    protected void onResume() {
        ...
        binding.mainNavView.getMenu().getItem(1).setChecked(true);
    }
    ...
    public void onBackPressed() {
        if (this.binding.homeDrawerlayout.isDrawerOpen(GravityCompat.START)) {
            ...
            AppHelper.showShortToast(BlogTemplateActivity.this, "Please click BACK again to exit");
    ...
    private void initView() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_blog_template_layout);
    ...
    private void initListener() {
        ...
        binding.homeToolbar.toolbarMenuNotification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(BlogTemplateActivity.this, NotificationActivity.class));
            }
        });
        ...
        binding.homeToolbar.toolbarMenuSearch.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BlogTemplateActivity.this, SearchPostActivity.class));
            }
        });
    ...
    private void initSliderViewPager() {
        ...
        sliderAdapter.setSliderItemClickListerner(new ItemClickListener() {
            ...
            public void onItemClickGetPosition(int position) {
                ...
                startActivity(new Intent(BlogTemplateActivity.this, PostDetailActivity.class).putExtras(bundle));
            }
        });
    }

    private void initTablayout() {
        homeTwoPageAdapter = new BlogTemplatePagerAdapter(getSupportFragmentManager(), (ArrayList<CategoryModel>) categoryList);
        binding.categoryPostsViewpager.setAdapter(homeTwoPageAdapter);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    ...
                    (BlogTemplateActivity.this).runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            ...
                            if (categoryList != null && categoryList.size() > 0) {
                                homeTwoPageAdapter.notifyDataSetChanged();
