...
import com.bestweby.enewz.databinding.ItemArticlePostListLayoutBinding;
 ...
 */
public class ArticlePostListAdapter extends RecyclerView.Adapter<ArticlePostListAdapter.ArticlePostViewHolder> {
    ...
    public ArticlePostListAdapter() {
    }

    public ArticlePostListAdapter(Context context, List<PostModel> arrayList) {
    ...
    @NonNull
    @Override
    public ArticlePostViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        return new ArticlePostViewHolder((ItemArticlePostListLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_article_post_list_layout, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final ArticlePostViewHolder holder, final int position) {
    ...
    public class ArticlePostViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        ItemArticlePostListLayoutBinding binding;

        ArticlePostViewHolder(@NonNull ItemArticlePostListLayoutBinding layoutBinding) {
