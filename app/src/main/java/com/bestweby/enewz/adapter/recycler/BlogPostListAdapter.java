...
import com.bestweby.enewz.databinding.ItemBlogPostListLayoutBinding;
 ...
 */
public class BlogPostListAdapter extends RecyclerView.Adapter<BlogPostListAdapter.BlogPostListViewHolder> {
    ...
    public BlogPostListAdapter() {
    }

    public BlogPostListAdapter(Context context, List<PostModel> arrayList) {
    ...
    @NonNull
    @Override
    public BlogPostListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        return new BlogPostListViewHolder((ItemBlogPostListLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_blog_post_list_layout, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull BlogPostListViewHolder holder, final int position) {
    ...
    private void loadComments(final BlogPostListViewHolder holder, int postId) {
    ...
    public class BlogPostListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        ItemBlogPostListLayoutBinding binding;

        public BlogPostListViewHolder(@NonNull ItemBlogPostListLayoutBinding layoutBinding) {
