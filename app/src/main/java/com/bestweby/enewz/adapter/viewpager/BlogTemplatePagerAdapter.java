...
import com.bestweby.enewz.fragment.BlogPostListFragment;
 ...
 */
public class BlogTemplatePagerAdapter extends FragmentStatePagerAdapter {

    private ArrayList<CategoryModel> categoryList;

    public BlogTemplatePagerAdapter(FragmentManager fm, ArrayList<CategoryModel> categoryModels) {
    ...
    public Fragment getItem(int i) {
        ...
        Fragment postListFragment = new BlogPostListFragment();
