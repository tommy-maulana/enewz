...
import com.bestweby.enewz.databinding.ItemCategoryGridPostListLayoutBinding;
 ...
 */
public class CategoryGridPostListAdapter extends RecyclerView.Adapter<CategoryGridPostListAdapter.CategoryPostListViewHolder> {
    ...
    public CategoryGridPostListAdapter() {
    }

    public CategoryGridPostListAdapter(Context context, List<PostModel> arrayList) {
    ...
    @NonNull
    @Override
    public CategoryGridPostListAdapter.CategoryPostListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        return new CategoryPostListViewHolder((ItemCategoryGridPostListLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_category_grid_post_list_layout, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull CategoryGridPostListAdapter.CategoryPostListViewHolder holder, final int position) {
    ...
    private void loadComments(final CategoryGridPostListAdapter.CategoryPostListViewHolder holder, int postId) {
    ...
    public class CategoryPostListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{

        ItemCategoryGridPostListLayoutBinding binding;

        CategoryPostListViewHolder(@NonNull ItemCategoryGridPostListLayoutBinding layoutBinding) {
