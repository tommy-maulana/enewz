...
import com.bestweby.enewz.databinding.ItemFeedPostListLayoutBinding;
 ...
 */
public class FeedPostListAdapter extends RecyclerView.Adapter<FeedPostListAdapter.FeedPostListViewHolder> {
    ...
    public FeedPostListAdapter() {
    }

    public FeedPostListAdapter(Context context, List<PostModel> arrayList) {
    ...
    @NonNull
    @Override
    public FeedPostListViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        return new FeedPostListViewHolder((ItemFeedPostListLayoutBinding) DataBindingUtil.inflate(LayoutInflater.from(context), R.layout.item_feed_post_list_layout, viewGroup, false));
    }

    @Override
    public void onBindViewHolder(@NonNull FeedPostListViewHolder holder, final int position) {
    ...
    private void loadComments(final FeedPostListViewHolder holder, int postId) {
    ...
    public class FeedPostListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        ItemFeedPostListLayoutBinding binding;

        FeedPostListViewHolder(@NonNull ItemFeedPostListLayoutBinding layoutBinding) {
