...
public class ActivityNewsTemplateLayoutBindingImpl extends ActivityNewsTemplateLayoutBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(3, 
            new String[] {"shimmer_news_pager_layout"},
            new int[] {6},
            new int[] {com.bestweby.enewz.R.layout.shimmer_news_pager_layout});
    ...
    public ActivityNewsTemplateLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private ActivityNewsTemplateLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            ...
            , (com.bestweby.enewz.databinding.ShimmerNewsPagerLayoutBinding) bindings[6]
        ...
        setContainedBinding(this.homeLinearShimmerView);
    ...
    public void invalidateAll() {
        ...
        homeLinearShimmerView.invalidateAll();
        requestRebind();
    }
    ...
    public boolean hasPendingBindings() {
        ...
        if (homeLinearShimmerView.hasPendingBindings()) {
            return true;
        }
        return false;
    }
    ...
    public void setLifecycleOwner(@Nullable androidx.lifecycle.LifecycleOwner lifecycleOwner) {
        ...
        homeLinearShimmerView.setLifecycleOwner(lifecycleOwner);
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 1 :
                return onChangeHomeLinearShimmerView((com.bestweby.enewz.databinding.ShimmerNewsPagerLayoutBinding) object, fieldId);
            case 2 :
    ...
    private boolean onChangeHomeLinearShimmerView(com.bestweby.enewz.databinding.ShimmerNewsPagerLayoutBinding HomeLinearShimmerView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x2L;
            }
    ...
    protected void executeBindings() {
        ...
        executeBindingsOn(homeLinearShimmerView);
    }
    ...
    /* flag mapping
        ...
        flag 1 (0x2L): homeLinearShimmerView
        flag 2 (0x3L): homeToolbar
        flag 3 (0x4L): null
    flag mapping end*/
    //end
}