...
public class ActivityArticleTemplateLayoutBindingImpl extends ActivityArticleTemplateLayoutBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(2, 
            new String[] {"view_article_template_layout"},
            new int[] {4},
            new int[] {com.bestweby.enewz.R.layout.view_article_template_layout});
    ...
    public ActivityArticleTemplateLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ActivityArticleTemplateLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            , (com.bestweby.enewz.databinding.ViewArticleTemplateLayoutBinding) bindings[4]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeContentView((com.bestweby.enewz.databinding.ViewArticleTemplateLayoutBinding) object, fieldId);
            case 1 :
                return onChangeHomeToolbar((com.bestweby.enewz.databinding.HomeToolbarLayoutBinding) object, fieldId);
        }
        return false;
    }
    private boolean onChangeContentView(com.bestweby.enewz.databinding.ViewArticleTemplateLayoutBinding ContentView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
