...
public class ActivityFeedTemplateLayoutBindingImpl extends ActivityFeedTemplateLayoutBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(3, 
            new String[] {"shimmer_feed_pager_layout"},
            new int[] {6},
            new int[] {com.bestweby.enewz.R.layout.shimmer_feed_pager_layout});
    ...
    public ActivityFeedTemplateLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 12, sIncludes, sViewsWithIds));
    }
    private ActivityFeedTemplateLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            ...
            , (com.bestweby.enewz.databinding.ShimmerFeedPagerLayoutBinding) bindings[6]
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            ...
            case 2 :
                return onChangeFeedShimmerView((com.bestweby.enewz.databinding.ShimmerFeedPagerLayoutBinding) object, fieldId);
        }
        return false;
    }
    ...
    private boolean onChangeFeedShimmerView(com.bestweby.enewz.databinding.ShimmerFeedPagerLayoutBinding FeedShimmerView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x4L;
            }
