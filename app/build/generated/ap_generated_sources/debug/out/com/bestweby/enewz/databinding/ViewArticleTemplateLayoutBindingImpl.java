...
public class ViewArticleTemplateLayoutBindingImpl extends ViewArticleTemplateLayoutBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(3, 
            new String[] {"shimmer_article_post_layout"},
            new int[] {6},
            new int[] {com.bestweby.enewz.R.layout.shimmer_article_post_layout});
    ...
    public ViewArticleTemplateLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 13, sIncludes, sViewsWithIds));
    }
    private ViewArticleTemplateLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 3
            , (com.bestweby.enewz.databinding.ShimmerArticlePostLayoutBinding) bindings[6]
        ...
        setContainedBinding(this.articleShimmerView);
    ...
    public void invalidateAll() {
        ...
        articleShimmerView.invalidateAll();
        requestRebind();
    }
    ...
    public boolean hasPendingBindings() {
        ...
        if (articleShimmerView.hasPendingBindings()) {
            return true;
        }
        return false;
    }
    ...
    public void setLifecycleOwner(@Nullable androidx.lifecycle.LifecycleOwner lifecycleOwner) {
        ...
        articleShimmerView.setLifecycleOwner(lifecycleOwner);
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeArticleShimmerView((com.bestweby.enewz.databinding.ShimmerArticlePostLayoutBinding) object, fieldId);
            case 1 :
    ...
    private boolean onChangeArticleShimmerView(com.bestweby.enewz.databinding.ShimmerArticlePostLayoutBinding ArticleShimmerView, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        executeBindingsOn(articleShimmerView);
    }
    ...
    /* flag mapping
        flag 0 (0x1L): articleShimmerView
