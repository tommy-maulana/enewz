...
public class ActivityMyFavouritesLayoutBindingImpl extends ActivityMyFavouritesLayoutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.my_favourites_recycler, 2);
        sViewsWithIds.put(R.id.empty_list_layout, 3);
        sViewsWithIds.put(R.id.banner_ad_layout, 4);
    }
    // views
    @NonNull
    ...
    public ActivityMyFavouritesLayoutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityMyFavouritesLayoutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
